...
Scene: `{"episode_id": 24, "file_path": "/nfs/kun2/users/homer/datasets/bridge_data_all/numpy_256/bridge_data_v2/deepthought_toykitchen2/stack_blocks/09/train/out.npy", "language": "put the rectangle block on top of the red arch and yellow block", "record_index": 3}`; diffusion seed: `0`.
...
|---|---:|---:|---:|---:|---:|
| feedback_condition | 40/40 | 28/30/32 | 30.1999 | 0 | 0.9643/0.9806 |
| float_rgb_final | 40/40 | 27/30/32 | 25.9137 | 0 | 0.9167/0.9769 |
| predicted_latent | 40/40 | 29/30/32 | 30.2656 | 0 | 0.9812/0.9973 |
